...
<body>
    ...
    <section id="contact-us" style="background-color: #f4f4f4; padding: 20px; text-align: center;">
        <h2 style="color: #333;">Contact Us</h2>
        <p style="font-size: 18px;">Thank you for your interest in Courses. Please use the information below to contact us.</p>
        <div class="contact-info" style="display: flex; justify-content: space-around; margin-top: 20px;">
            <div class="contact-item">
                <img src="hosp1.jpg" alt="Location" style="width: 48px; height: 48px;">
                <p style="margin-top: 10px;">Chandigarh, Haryana</p>
            </div>
            <div class="contact-item">
                <img src="phone.png" alt="Phone" style="width: 48px; height: 48px;">
                <p style="margin-top: 10px;">+91 8708 271 878</p>
            </div>
            <div class="contact-item">
                <img src="gmail.png" alt="Email" style="width: 48px; height: 48px;">
                <p style="margin-top: 10px;">ankitgarg3738@gmail.com</p>
            </div>
        </div>
    </section>
